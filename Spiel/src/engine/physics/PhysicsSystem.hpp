...
//private: 
//	void updateCollisionSet(CollisionSystem& collSys, World& world);
//	void findIslands(CollisionSystem& collSys, World& world);
//	void springPushout(CollisionSystem& collSys, World& world);
//	PushoutCalcJob startPushoutJob(CollisionSystem& collSys, World& world);
//	void warmStart(CollisionSystem& collSys, World& world);
...
//
//	// configuration:
//	const int impulseResulutionIterations = 5;		// number of iterations of impulse propagation per frame									(recommendet value = 3 with low forces to 15 with high forces)
...
//	std::vector<std::vector<CollisionInfo>> collInfoIslands;	// buffer for collisionInfos of the islands
//	std::vector<CollisionInfo> collInfoIslandsBorder;			// buffer for collisionInfos on the borders
