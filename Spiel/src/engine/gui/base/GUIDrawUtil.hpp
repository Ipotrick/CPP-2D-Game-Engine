...
namespace gui {
	...
	/**
	 * \return the position of the top left corner of the area generated by the placeing sizeing and context.
	 */
	...
	/**
	 * \return the position of the bottom right corner of the area generated by the placeing sizeing and context.
	 */
